  ...
  head: () => ({
    ...
    meta: [
      { title: 'How the Moon makes two high tides · Slackwater' },
      {
        name: 'description',
        content:
          'An interactive explanation of the near-side and far-side ocean bulges, using the Earth–Moon barycenter.',
      },
      ...
      <article>
        ...
        <section className="mx-auto mt-20 grid max-w-4xl gap-8 sm:mt-28 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:gap-12">
          <div className="lg:order-2">
            ...
            <div className="mt-5 space-y-4 text-lg leading-relaxed text-sw-foam">
              <p>
                Earth and the Moon both orbit their barycenter. It sits inside Earth, offset from
                the planet&rsquo;s center, so Earth&rsquo;s center travels around a small circle.
              </p>
              <p>
